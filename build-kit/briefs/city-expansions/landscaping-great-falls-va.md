# Expansion Brief: /service-areas/landscaping-great-falls-va
...
## Keywords
no tracked keyword: optimize "landscaping great falls va"; supports patio-deck-fire-pit history
...
2. H2 local knowledge section: Acre-plus estates, deer-resistant planting
3. Local proof block: Katie Bird pool + hardscape photo set EXCLUSIVE here
4. Expanded neighborhoods line: Forestville, Seneca area, river-adjacent estates (exclusive; replaces nothing, extends the existing one-liner)
