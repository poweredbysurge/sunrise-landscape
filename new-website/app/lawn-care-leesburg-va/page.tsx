...
export const metadata: Metadata = {
  ...
  description:
    'Full-season lawn care in Leesburg, VA from a crew that has worked Loudoun lawns since 1986. Mowing, fertilization, aeration, weed control. Free consultation.',
