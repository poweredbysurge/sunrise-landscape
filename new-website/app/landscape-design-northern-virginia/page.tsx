...
const featuredProjects = [
  {
    img: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7a462c7d0f5245e2a462_cover.webp'),
    ...
    images: [
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7a462c7d0f5245e2a462_cover.webp'), alt: 'Backyard of a beige house with a multi-level stone patio, outdoor seating areas, and lush landscaping including shrubs and a red bush.' },
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7bb1405fd774eb893c78_folder-1-2(1).webp'), alt: 'Aerial view of a curved stone patio with a fire pit, seating area, and stepping-stone path through mulched garden beds leading up to a covered deck.' },
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7bb07b41400be77ae7e6_folder-1-3 (1).webp'), alt: "Aerial view of a home's screened porch and covered patio with a stone paver terrace, retaining wall, and fire pit area surrounded by lawn." },
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7bb0ffa8d3d4fbc19022_folder-1-4 (1).webp'), alt: 'Overhead view of a curved stone retaining wall, mulched planting beds, and a circular fire pit patio with seating.' },
    ],
  },
  {
    ...
    location: 'Ashburn, VA',
    images: [
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7d113c21f26f490bb45a_folder-2-cover-1.webp'), alt: 'Backyard patio with stone walkway over a koi pond, small waterfall, outdoor fireplace, and patio furniture under a blue sky.' },
  ...
  },
  {
    ...
    location: 'Vienna, VA',
    images: [
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7e1387270569bd211cb9_folder-3-cover.webp'), alt: 'Large two-story house with brick and stone facade, a gray shingled roof, and a manicured garden in front.' },
  ...
  },
  {
    ...
    location: 'Oakton, VA',
    images: [
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7ecfc4042333b3219c72_folder-4-cover.webp'), alt: 'Large two-story brick house with a manicured lawn and trees in the background under a clear blue sky.' },
  ...
  },
  {
    ...
    images: [
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/686b7fb273f8f7c44bbbc942_folder-5-cover.webp'), alt: 'Backyard with a rectangular swimming pool, lounge chairs, and a covered patio area with outdoor seating and a fireplace.' },
  ...
  },
  {
    ...
    location: 'Vienna, VA',
    images: [
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/6889b8bd5d405760963255ff_Katie Bird Pool 3.jpg'), alt: 'Modern house with beige walls and dark roof, a pool with hot tub, lounge chairs, umbrellas, and white flowering bushes in the foreground.' },
      ...
      { src: cdnToLocal('/media/6808afe22b48076cc8e63cef/6889b8bd026e584fa3a5e8cf_Katie Bird Boulder Retaining Wall 1.jpg'), alt: 'Natural boulder retaining wall with layered plantings of hostas, ferns, and evergreens beside a stone home.' },
    ],
  },
]
