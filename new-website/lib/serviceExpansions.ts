  ...
  'commercial-landscape-maintenance-virginia': {
    sections: [
      ...
      },
      {
        ...
        body: [
          'HOA and commercial budgets run on calendars, so we do too: proposals timed for budget season, pricing broken out line by line so it survives comparison, and contract scopes written in plain language a board can vote on. Working in Northern Virginia since 1986, we know exactly what a February board meeting wants to see.',
        ],
      },
    ],
